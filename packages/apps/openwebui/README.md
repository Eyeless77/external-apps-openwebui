...
| `openwebui.ingress.class`       | IngressClass name (defaults to release namespace / tenant name). | `string`   | `""`        |
| `openwebui.ingress.host`        | Ingress host (defaults to <release-name>.<tenant-host>).         | `string`   | `""`        |
